...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_91b795206ace4f8c93887e0912a519c1)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_91b795206ace4f8c93887e0912a519c1 flight_id '6376a371797b4a3585f5450beeeef45c' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_6376a371797b4a3585f5450beeeef45c)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_6376a371797b4a3585f5450beeeef45c flight_name 'Big Balloon iTVC Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '44e27891fe0a42da89ee4889c574c101' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '88a1909a30b443f3b01993755ce1c640' audience_id 'fb8d61f9890a415b8756dd7fce6a1c54' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_44e27891fe0a42da89ee4889c574c101)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_44e27891fe0a42da89ee4889c574c101 creative_source '{"source":"2016\/12\/nescafe\/bigballon\/index.html","max_width":"800","max_height":"500","min_width":"300","min_height":"250","bar_height":"100","duration":"30"}' ad_format 'a4780184500f4cb99e2b25ec5e57be3c' banner_type 'template' template_name 'display_big_balloon_itvc' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_a4780184500f4cb99e2b25ec5e57be3c)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_a4780184500f4cb99e2b25ec5e57be3c format_name 'Display Big Balloon (iTVC) (VN)' tags 'balloon' video '1')
