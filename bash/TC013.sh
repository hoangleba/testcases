...
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_8a7b618f482f429293c36e1c852c013a zone_id '1a7cf454312443ccad4bc03c5828a5ac' height '1' width '1' type 'display' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["ff24968dda274e35b9cb7d64f87c4c6c"]' placement_settings '{"position":{"insert":"last_child","name":"header","type":"id"}}')
...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_ff24968dda274e35b9cb7d64f87c4c6c)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_ff24968dda274e35b9cb7d64f87c4c6c flight_id '5172df05592c4cf688f0daa7b6adf252' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_5172df05592c4cf688f0daa7b6adf252)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_5172df05592c4cf688f0daa7b6adf252 flight_name 'HTML Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '785a695d4a1a49989fd92c5d77a0e94c' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '7a71d1c2ddc84622a4c2b51b4bb537c5' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_785a695d4a1a49989fd92c5d77a0e94c)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_785a695d4a1a49989fd92c5d77a0e94c creative_source '<style>[id^=yomedia-destination]{text-align: center;}</style>
<SCRIPT SRC="//ib.adnxs.com/ttj?id=11125078&cb=[yo_cb]&pubclick=[yo_click]&Psa=0" TYPE="text/javascript"></SCRIPT>' ad_format '4d224c8d344d42c6aed63ea11472cd00' banner_type 'html_code' template_name 'display_html' landing_page 'http://yomedia.vn')
