...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_fc308c1c5b294eab8bde31faf56f662a)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_fc308c1c5b294eab8bde31faf56f662a flight_id '365ee09b5d434b82ab0eb9c93e293a4e' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_365ee09b5d434b82ab0eb9c93e293a4e)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_365ee09b5d434b82ab0eb9c93e293a4e flight_name 'Page Take Over Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '7cdd020aeaae4341a93edba039349c80' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '7a71d1c2ddc84622a4c2b51b4bb537c5' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_7cdd020aeaae4341a93edba039349c80)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_7cdd020aeaae4341a93edba039349c80 creative_source '{"basic_source":"http:\/\/demo.yomedia.vn\/2017\/banner-testing\/page-takeover-v1\/970x250\/index.html","expand_source":"http:\/\/demo.yomedia.vn\/2017\/banner-testing\/page-takeover-v1\/1600x900\/index.html","basic_width":"970","basic_height":"250"}' ad_format '99399b094c4849999ec422b3d5b6de90' banner_type 'template' template_name 'display_page_takeover' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_99399b094c4849999ec422b3d5b6de90)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_99399b094c4849999ec422b3d5b6de90 format_name 'Display Page Takeover (VN)')
