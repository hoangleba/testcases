...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_b51111e2c26e436786d04cc0785c6d03)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_b51111e2c26e436786d04cc0785c6d03 flight_id 'e019d93ec9584d1eb8fdbd3d55f461de' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_e019d93ec9584d1eb8fdbd3d55f461de)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_e019d93ec9584d1eb8fdbd3d55f461de flight_name 'Bottom Up Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id 'fb7dfafb32814323b1bed1abd7121304' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '88a1909a30b443f3b01993755ce1c640' audience_id 'fb8d61f9890a415b8756dd7fce6a1c54' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_fb7dfafb32814323b1bed1abd7121304)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_fb7dfafb32814323b1bed1abd7121304 creative_source '{"source":"2016\/10\/toshiba-oct\/maylanh-bottomup\/index.html","max_width":"1200","max_height":"600","min_width":"1200","min_height":"120","bar_height":"30"}' ad_format '25597e3a653448a58e77a31e88d68e6a' banner_type 'template' template_name 'display_bottom_up' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_25597e3a653448a58e77a31e88d68e6a)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_25597e3a653448a58e77a31e88d68e6a format_name 'Display Bottom Up (VN)')
