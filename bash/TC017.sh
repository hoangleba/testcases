...
# Placement
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT DEL pl_8c8ce24010684969ae0e053ccdae5d6d)
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_8c8ce24010684969ae0e053ccdae5d6d zone_id '0d8a36c9531c4e0bbb596a27cf2827e8' height '1' width '1' type 'display' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["104e591421894903928ae31a49855e83"]' placement_settings '{"min_width":"1","min_height":"1","max_width":"1","max_height":"1"}')
...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_104e591421894903928ae31a49855e83)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_104e591421894903928ae31a49855e83 flight_id '1fbe2defd7224e2fb0e98bc63e6aeb78' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_1fbe2defd7224e2fb0e98bc63e6aeb78)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_1fbe2defd7224e2fb0e98bc63e6aeb78 flight_name 'Display Inpage iTVC Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id 'c000bd8f400c4156b9c145373cbdcdcc' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '7a71d1c2ddc84622a4c2b51b4bb537c5' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_c000bd8f400c4156b9c145373cbdcdcc)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_c000bd8f400c4156b9c145373cbdcdcc creative_source '{"source":"2017\/06\/ultherapy\/balloon-standard-op1\/index.html","width":"300","height":"250","duration":"30"}' ad_format '780fc9f79f0b4c47ab4fde1005173cfe' banner_type 'template' template_name 'display_inpage_itvc' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_780fc9f79f0b4c47ab4fde1005173cfe)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_780fc9f79f0b4c47ab4fde1005173cfe format_name 'Display In-page (iTVC) (VN)' video '1')
