...
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_8fe6dd1535314f49bf555cd364a970bf zone_id '9134ee8212d845fbbe67c788b229188c' height '1' width '1' type 'mobile' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["0a188601d5fd4d419fa3719328cde8ec"]')
...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_0a188601d5fd4d419fa3719328cde8ec)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_0a188601d5fd4d419fa3719328cde8ec flight_id '0f2fb07c7d8345c4a59b00ecae255e5e' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_0f2fb07c7d8345c4a59b00ecae255e5e)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_0f2fb07c7d8345c4a59b00ecae255e5e flight_name 'Mobile Interstitial Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '17b8888cb0df4684acf3c6aa0103b411' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '77f5c394455141bb9f83c434231492c1' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_17b8888cb0df4684acf3c6aa0103b411)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_17b8888cb0df4684acf3c6aa0103b411 creative_source '{"source":"2016\/06\/firstview_itvc\/index.html"}' ad_format '0782370495be4712ba5a0e0e905a1bd8' banner_type 'template' template_name 'mobile_interstitial' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_0782370495be4712ba5a0e0e905a1bd8)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_0782370495be4712ba5a0e0e905a1bd8 format_name 'Mobile Interstitial (VN)')
