...
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_0681c381c8364325a1a242bd9340eebf zone_id 'dba74dc8bb6d42c4a17147b6b3777e22' height '1' width '1' type 'video' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["4ec67dfba66a4385b3ed96284186ec22","73e599eafcb94e3ba0c7cfaa5afe9ab0","dac6a81fc42242d893e4e9d0532e4de7","fbec7e598a734c9b901f6261e4f3ac5f"]' placement_settings '{"video_ad_format":"preroll","config":"vast","show_skip":"1","show_after":"7","ad_duration":"30"}')
...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_73e599eafcb94e3ba0c7cfaa5afe9ab0)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_73e599eafcb94e3ba0c7cfaa5afe9ab0 flight_id 'c84c9f0affd54c518d2433b0f1ec4b23' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_c84c9f0affd54c518d2433b0f1ec4b23)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_c84c9f0affd54c518d2433b0f1ec4b23 flight_name 'Preroll Vpaid Flash Custom Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id 'e95227235e6d4658a08ab6472af7ddd7' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '47eb13ff3ed442c6af21579c5b4429ae' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_e95227235e6d4658a08ab6472af7ddd7)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_e95227235e6d4658a08ab6472af7ddd7 creative_source '{"flash_player":"http:\/\/media_obj.9730a73b.cdnviet.com\/2016\/12\/nuti\/preroll-pc\/ExampleVpaid_70s.swf","flash_banner":"http:\/\/media_obj.9730a73b.cdnviet.com\/2016\/12\/nuti\/preroll-pc\/nuti.swf","skip_ad":"7","duration":"27"}' ad_format '2a3cd6f5569c4ceaa5b0d4025ac28c3b' banner_type 'template' template_name 'video_preroll_custom_vpaid' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_2a3cd6f5569c4ceaa5b0d4025ac28c3b)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_2a3cd6f5569c4ceaa5b0d4025ac28c3b format_name 'Video Pre-roll (custom) (Vpaid) (VN)')
