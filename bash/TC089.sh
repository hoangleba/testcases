...
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_0681c381c8364325a1a242bd9340eebf zone_id 'dba74dc8bb6d42c4a17147b6b3777e22' height '1' width '1' type 'video' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["1fbe6ba7320c451e8aa010e5be201878","1fba192d14d44acb9f61a8e5c65ac1dd"]' placement_settings '{"video_ad_format":"preroll","config":"vast","show_skip":"1","show_after":"7","ad_duration":"30"}')

# Zone
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT DEL z_dba74dc8bb6d42c4a17147b6b3777e22)
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET z_dba74dc8bb6d42c4a17147b6b3777e22 efa9b2ec434447dd9e9f654a233f1c61 '{"fallback_source":"http:\/\/req.tidaltv.com\/vmm.ashx?mt=1&pid=34025&ap=0&xf=35&rand=[timestamp]&refUrl=[ref]","weight":"1"}')
...
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_1fba192d14d44acb9f61a8e5c65ac1dd)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_1fba192d14d44acb9f61a8e5c65ac1dd flight_id '01d054dee2e242f6ad2b4236d711eb26' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_e1ffb7ca9dbc4f529a2b2c45170bf2a1)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_e1ffb7ca9dbc4f529a2b2c45170bf2a1 flight_name 'Preroll Inline 15s Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '1f485d37968d4e8fb2e1f1c1fe5f49b2' delivery_id 'eebe98f29524431faf52d43732426ec4' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '47eb13ff3ed442c6af21579c5b4429ae' bookings '1000.00')
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_01d054dee2e242f6ad2b4236d711eb26)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_01d054dee2e242f6ad2b4236d711eb26 flight_name 'Preroll Wrapper 15s Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id 'e385464d674c4558b4e06cc92b01bc46' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '47eb13ff3ed442c6af21579c5b4429ae' bookings '1000.00')
...
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_e385464d674c4558b4e06cc92b01bc46)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_e385464d674c4558b4e06cc92b01bc46 creative_source '{"source":"https:\/\/svastx.moatads.com\/performicsvnmjnvpaid634209250683\/2aaab8ed45394fad9f12c4da93f922c9_-_McQueen_iTVC_Preroll.xml","skip_ad":"7","vast_included":0,"vast_expired":"5","duration":"15"}' ad_format '2b35201862c547fd80e02d67d327768e' banner_type 'template' template_name 'video_preroll_15s_wrapper' landing_page 'http://yomedia.vn')
...
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_2b35201862c547fd80e02d67d327768e)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_2b35201862c547fd80e02d67d327768e format_name 'Video Pre-roll 15s (Wrapper) (VN)')
...
result=$(redis-cli -h $DELIVERIES_HOST -p $DELIVERIES_PORT DEL dl_eebe98f29524431faf52d43732426ec4)
result=$(redis-cli -h $DELIVERIES_HOST -p $DELIVERIES_PORT HMSET dl_eebe98f29524431faf52d43732426ec4 date_range '[{"from":"2016-08-05","to":"2017-08-05"},{"from":"2017-08-06","to":"2018-09-13"}]' geo_country '["vn"]')
