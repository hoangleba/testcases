...
result=$(redis-cli -h $PLACEMENTS_HOST -p $PLACEMENTS_PORT HMSET pl_0681c381c8364325a1a242bd9340eebf zone_id 'dba74dc8bb6d42c4a17147b6b3777e22' height '1' width '1' type 'video' website_id 'ad85c58281be4b9682a42a5c9b7dd219' advertisements '["4ec67dfba66a4385b3ed96284186ec22","e7ae1b96d0a848e1a3bf71e1660c4c19","dac6a81fc42242d893e4e9d0532e4de7","fbec7e598a734c9b901f6261e4f3ac5f"]' placement_settings '{"video_ad_format":"preroll","config":"vast","show_skip":"1","show_after":"7","ad_duration":"30"}')
...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_e7ae1b96d0a848e1a3bf71e1660c4c19)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_e7ae1b96d0a848e1a3bf71e1660c4c19 flight_id '6ea7436fe3444aa4a16c14ab0766390b' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_6ea7436fe3444aa4a16c14ab0766390b)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_6ea7436fe3444aa4a16c14ab0766390b flight_name 'Preroll Vpaid Flash 30s Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '620eda5115fc46dca2e2c9e38471b84c' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '47eb13ff3ed442c6af21579c5b4429ae' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_620eda5115fc46dca2e2c9e38471b84c)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_620eda5115fc46dca2e2c9e38471b84c creative_source '{"flash_player":"http:\/\/media_obj.9730a73b.cdnviet.com\/2016\/12\/nuti\/preroll-pc\/ExampleVpaid_70s.swf","flash_banner":"http:\/\/media_obj.9730a73b.cdnviet.com\/2016\/12\/nuti\/preroll-pc\/nuti.swf","skip_ad":"7","duration":"30"}' ad_format '9c34181b3e2a4516979a1a665c6e91f6' banner_type 'template' template_name 'video_preroll_30s_vpaid' landing_page 'http://yomedia.vn')

# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_9c34181b3e2a4516979a1a665c6e91f6)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_9c34181b3e2a4516979a1a665c6e91f6 format_name 'Video Pre-roll 30s (Vpaid) (VN)')
