...
# Advertisement
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT DEL ad_9407e8c8ba5042cea891c351a5672107)
result=$(redis-cli -h $ADVERTISEMENTS_HOST -p $ADVERTISEMENTS_PORT HMSET ad_9407e8c8ba5042cea891c351a5672107 flight_id 'ccda0dc7d6f74b3a8338e3c74974b61c' cost_received '0.000000' cost_paid '1.000000')

# Flight
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT DEL fl_ccda0dc7d6f74b3a8338e3c74974b61c)
result=$(redis-cli -h $FLIGHTS_HOST -p $FLIGHTS_PORT HMSET fl_ccda0dc7d6f74b3a8338e3c74974b61c flight_name 'Big Balloon Testing' buy_type 'cpm' added_value '0.00' bookings_type 'impression' daily_bookings '1' campaign_id '7eb3e2fc77e04bc984eb548eba50b817' banner_id '8f578c853e1945d78831be570675cea9' delivery_id 'eebe98f29524431faf52d43732426ec3' category_id '51b6bb2730b74b7cb7f15c1bdaf075b4' product_id '88a1909a30b443f3b01993755ce1c640' audience_id 'fb8d61f9890a415b8756dd7fce6a1c54' bookings '1000.00')
...
# Banner
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT DEL b_8f578c853e1945d78831be570675cea9)
result=$(redis-cli -h $BANNERS_HOST -p $BANNERS_PORT HMSET b_8f578c853e1945d78831be570675cea9 creative_source '{"source":"2016\/09\/s26-phase2\/bigballoon\/index.html","max_width":"800","max_height":"500","min_width":"300","min_height":"250","bar_height":"150"}' ad_format 'cf8a59535777457ab2f6e1f0a61787a0' banner_type 'template' template_name 'display_big_balloon' landing_page 'http://yomedia.vn')
...
# Ad Format
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT DEL adf_cf8a59535777457ab2f6e1f0a61787a0)
result=$(redis-cli -h $ADFORMATS_HOST -p $ADFORMATS_PORT HMSET adf_cf8a59535777457ab2f6e1f0a61787a0 format_name 'Display Big Balloon (VN)' tags 'balloon')
